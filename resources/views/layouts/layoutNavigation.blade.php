...
x-data="{
    ...
    <header>
        <div class=" h-20  w-full z-2 shadow-lg flex items-center px-6 gap-10 sticky" style="background : rgba(20,20,20,0.6); backdrop-filter: blur(15px);">
