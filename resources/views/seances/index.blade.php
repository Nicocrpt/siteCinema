    ...
    <div x-data="seancesPage()" class="h-full bg-zinc-100 dark:bg-zinc-900 relative w-full">
        <div class="fixed top-0 w-full">
            <section class="w-full !h-[4rem] bg-zinc-100 dark:bg-zinc-900 mt-[56px] flex items-center justify-center relative">
                <button class="hover:bg-zinc-200 dark:hover:bg-zinc-800 p-2 rounded" @click="prev()" :class="today >= firstDate ? 'pointer-events-none' : ''">
                ...
                <button class="hover:bg-zinc-200 dark:hover:bg-zinc-800 p-2 rounded" @click="next()">
        ...
        <section class="min-h-screen bg-zinc-50 dark:bg-zinc-800 mx-1 xxs:mx-2 rounded pt-16 px-2">
