<div x-data="{currentPage: document.title}" class="relative h-12 max-h-16 w-full bg-zinc-100 dark:bg-zinc-900 shadow-xs">
    <ul class="flex dark:text-white h-full z-20">
        <li class="h-full w-fit p-2 px-4 z-30 flex items-center gap-2" :class="currentPage == 'Séances - Vue d\'ensemble' ? 'border-b-2 border-zinc-950 dark:border-white' : ''">
            ...
            <a class="font-semibold"  href="{{route('admin.seances.index')}}">Vue d'ensemble</a>
        </li>
        <li class="h-full w-fit p-2 px-4 z-30 flex items-center gap-2" :class="currentPage == 'Séances - Gérer les séances' ? 'border-b-2 border-zinc-950 dark:border-white' : ''">
            ...
            <a class=" font-semibold"  href="{{route('admin.seances.manage')}}">Gérer les seances</a>
        </li>
    </ul>
    <div class="absolute bottom-0 w-full !h-[2px] bg-zinc-200 dark:bg-zinc-600 z-10"></div>
</div>