...
@section('content')
    <div class="flex flex-col mt-20 md:mt-32 mx-2" x-data="{searchBar : false}">
        ...
        <div class="absolute top-0 left-0 transition-height ease-in-out duration-300 pt-32 md:pt-44 w-full" :class="!searchBar ? 'pt-32 md:pt-44 delay-75' : 'pt-48 md:pt-64'"
        x-init="$el.classList.remove('pt-32 md:pt-44')">
