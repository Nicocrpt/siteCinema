<div class="relative w-full mb-24 flex group" 
    ...
    <button class="absolute top-[45%] right-[2%] bg-zinc-500 text-zinc-200 bg-opacity-80  rounded-full lg:px-2 w-10 h-10 lg:h-12 lg:w-12 z-20 lg:opacity-0 lg:group-hover:opacity-100 lg:group-hover:bg-opacity-80 transition-opacity ease-in-out duration-500 shadow-lg backdrop-blur-sm"
