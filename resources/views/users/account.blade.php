...
@section('content')
    ...
    <div style="height: 100%; width: 100%" x-data="userPage()" x-init="init()" class="relative">
        ...
        <a @click="sideMenu = !sideMenu" class="md:hidden text-xl text-white w-fit px-4 ml-4 rounded-xl transition-all ease-in-out duration-[550ms] cursor-pointer absolute top-16 p-3 z-40 border-b" :class="sideMenu ? 'right-64 rounded-xl bg-zinc-50 hover:bg-white border-zinc-200' : 'right-0 bg-zinc-900  border-zinc-500 dark:border-zinc-950 mr-2 ' ">
