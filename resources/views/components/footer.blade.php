<div {{ $attributes->merge(['class' => "flex flex-col justify-between bg-neutral-900 w-full h-48 px-4 py-2 sticky "]) }}>
    ...
    <div class="pb-2 flex justify-around px-2">
        ...
        <div>
            <h3 class="text-neutral-50 text-sm font-semibold mb-1">Infos pratiques</h3>
            <ul class="text-neutral-50 text-xs gap-1 flex flex-col ">
                <li>Mentions légales</li>
                <li>Notre histoire</li>
                <li>Politique de confidentialité</li>
    ...
    <div class="w-full flex justify-center gap-4 pb-1">
        <a href="https://instagram.com/">
            <svg fill="#ffffff" viewBox="0 0 256 256" width="44" id="Flat" xmlns="http://www.w3.org/2000/svg" stroke="#ffffff"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M128,84a44,44,0,1,0,44,44A44.04978,44.04978,0,0,0,128,84Zm0,80a36,36,0,1,1,36-36A36.04061,36.04061,0,0,1,128,164ZM172,32H84A52.059,52.059,0,0,0,32,84v88a52.059,52.059,0,0,0,52,52h88a52.059,52.059,0,0,0,52-52V84A52.059,52.059,0,0,0,172,32Zm44,140a44.04978,44.04978,0,0,1-44,44H84a44.04978,44.04978,0,0,1-44-44V84A44.04978,44.04978,0,0,1,84,40h88a44.04978,44.04978,0,0,1,44,44ZM188,76a8,8,0,1,1-8-8A8.00917,8.00917,0,0,1,188,76Z"></path> </g></svg>
        </a>
